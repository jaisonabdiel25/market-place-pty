...
export abstract class IProductService {
    abstract getProducts(page: number, size: number, search: string): Promise<GlobalData<Product[]>>;
    ...
    abstract getProductByCategory(id: string, page: number, size: number): Promise<Product[]>;
}