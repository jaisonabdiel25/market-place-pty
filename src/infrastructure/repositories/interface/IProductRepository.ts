...
export abstract class IProductRepository {
    abstract getProducts(skip: number, take: number, search: string): Promise<[Product[], number]>;
    ...
    abstract getProductByCategory(id: string, skip: number, take: number): Promise<Product[]>;
}